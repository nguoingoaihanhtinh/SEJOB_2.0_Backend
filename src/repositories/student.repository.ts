...
export class StudentRepository {
  ...
  public readonly fields =
    "id, user_id, about, location, recommendation_config, location_id, skills, open_for_opportunities, phone_number, desired_positions, date_of_birth, gender, created_at, updated_at";
